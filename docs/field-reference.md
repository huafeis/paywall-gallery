...
| onboarding_count | Number of onboarding preview screens in the Onboarding segment of the captured video timeline. |
| walkthrough_count | Number of onboarding preview screens in the Walkthrough segment of the captured video timeline (after the video boundary). |
| paywall_type | Paywall classification from PaywallPro. When multiple distinct paywall types are observed across the captured pages, this is a comma-separated list in capture order. |
