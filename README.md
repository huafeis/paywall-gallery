...
A public dataset of 600 top iOS subscription app paywalls and onboarding flows, published by <a href="https://www.paywallpro.app/?utm_source=github&utm_medium=open_dataset&utm_campaign=paywall_gallery" target="_blank" rel="noopener noreferrer">PaywallPro</a>.
...
Current public release: 600 apps. We will keep adding 50 new apps every week.

The complete app index lives in [apps/index.md](apps/index.md). [Browse all 600 apps](apps/index.md).
