...
由 <a href="https://www.paywallpro.app/?utm_source=github&utm_medium=open_dataset&utm_campaign=paywall_gallery" target="_blank" rel="noopener noreferrer">PaywallPro</a> 发布的 Top 1060 iOS 订阅 App 的付费墙与 Onboarding 公开数据集。
...
当前公开版本：1060 个 App。后续会每周继续新增 50 个 App。
...
完整 App 索引位于 [apps/index.zh-CN.md](apps/index.zh-CN.md)。[浏览全部 1060 个 App](apps/index.zh-CN.md)。
